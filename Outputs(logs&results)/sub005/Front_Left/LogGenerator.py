...
cfg = rs.config()
cfg.enable_device_from_file("C:\Age_Estimation_Project\\bag_files\sub005\left\\front.bag", True)
logfile_color_name = "Sub005_Left_Front_color.txt"
logfile_depth_name = "Sub005_Left_Front_depth.txt"
